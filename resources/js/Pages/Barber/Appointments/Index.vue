...
const applyFilters = () => {
    router.get(route("barber.appointments.list"), filterForm.value, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
                    ...
                    >
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="h-10 w-10 rounded-xl bg-amber-500/10 text-amber-500 flex items-center justify-center text-xs font-black shadow-inner"
                                >
                                    {{ appt.customer?.name ? appt.customer.name.charAt(0) : 'W' }}
                                </div>
                                <div class="flex flex-col">
                                    <h4
